...
public class TileEntityTypes {
    ...
    public static final RegistryObject<TileEntityType<EnvironmentDetectorTileEntiy>> SQL_BRIDGE = Registration.TILE_ENTITIES.register("sql_bridge", ()->new TileEntityType<>(EnvironmentDetectorTileEntiy::new, Sets.newHashSet(Blocks.SQL_BRIDGE.get()), null));
